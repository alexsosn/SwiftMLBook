...
public class Solver {
    ...
    public struct TrainResult {
        public var forwardTime: Int
        public var backwardTime: Int
    ...
    public var net: Net
    public var learningRate: Float = Float(0.0)
    public var l1Decay: Float = Float(0.0)
    public var l2Decay: Float = Float(0.0)
    public var batchSize: Int = 0
    public var method: SolverType
    public var momentum: Float = Float(0.0)
    public var ρ: Float = Float(0.0)
    public var ε: Float = Float(0.0)
    public var β1: Float = Float(0.0)
    public var β2: Float = Float(0.0)
    public var k: Int = 0
    public var gsum: [[Float]] = []
    public var xsum: [[Float]] = []
    public var regression: Bool = false
    ...
    public init(net: Net, options: SolverOpt) {
        ...
        if net.layers[net.layers.count - 1] is RegressionLayer {
            regression = true
        } else {
            regression = false
        }
